<footer>
                <div class="w-100 style3 pt-85 dark-layer2 opc87 position-relative">
                    <div class="fixed-bg" style="background-image: url(assets/images/parallax-bg12.jpg);"></div>
                    <div class="container">
                        <div class="footer-data w-100">
                            <div class="row justify-content-between mrg30">
                                <div class="col-md-6 col-sm-6 col-lg-3">
                                    <div class="widget-box v2 w-100">
                                        <div class="logo position-relative"><h1 class="mb-0"><a class="d-block" href="index.html" title="Home"><img class="img-fluid" src="assets/images/logo-2.png" alt="Logo" srcset="assets/images/logo-2.png"></a></h1></div><!-- Logo -->
                                        <p class="mb-0">Goalball Federation of India (GFI) promotes Goalball for blind and visually impaired athletes across India. </p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-lg-3">
                                    <div class="widget-box v2 w-100">
                                        <h4 class="widget-title2 position-relative"><i class="fas fa-trophy thm-clr position-absolute"></i>Navigate our site</h4>
                                        <ul class="mb-0 list-unstyled w-100">
                                            <li><a href="#" title="">About</a></li>
                                            <li><a href="#" title="">Trainers</a></li>
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-3">
                                    <div class="widget-box v2 w-100">
                                        <h4 class="widget-title2 position-relative"><i class="fas fa-trophy thm-clr position-absolute"></i>Explore</h4>
                                        <ul class="mb-0 list-unstyled w-100">
                                            
                                            <li><a href="#" title="">Our Center</a></li>
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-3">
                                    <div class="widget-box v2 w-100">
                                        ...
                                        <ul class="contact-info-list mb-0 list-unstyled w-100">
                                            ...
                                            <li><span>Mail Id:</span><a href="mailto:info@goalballindia.in" title="">info@goalballindia.in</a></li>
                                            <li>India</li>
                                        </ul>
                                    </div>
                                </div>
